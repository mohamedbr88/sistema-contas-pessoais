...
// ============================================================================
import { S, V, A0, MESES, CATS, CATD, cor, esc, noMes, viagemAtual } from './estado.js?v=20260720-7';
import { contasDoMes, diarioDoMes, resumoMes, somaEstimado, somaPago, somaValor, valorEmBRL } from './calculos.js?v=20260720-7';
import { M, Mc, VE } from './moeda.js?v=20260720-7';
import { baixar } from './ui.js?v=20260720-7';
